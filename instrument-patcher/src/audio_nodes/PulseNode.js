...
export class PulseNode extends CustomAudioNode {
    constructor(context, initialFrequency = 0, initialPulseWidth = 0.5) {
        super(context);
        Object.defineProperty(this, "_frequencySource", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_pulseWidthSource", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_phaseSource", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
